      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html:
              "try{var t=localStorage.getItem('bhm:theme')||'dark';if(t==='dark'){document.documentElement.classList.add('dark');}}catch(e){document.documentElement.classList.add('dark');}",
          }}
        />
